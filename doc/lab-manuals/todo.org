...
* [0/2] Lab 4
** TODO [0/3] preparation
*** BLOCKED analog interface design/low-pass filter               :hershal:
...
**** TODO [2/4] add interpreter commands:                           :eric:
***** DONE enable/disable sampling
***** TODO enable/disable filtering
***** DONE print out the raw adc data
***** TODO print out the filtered adc data
*** IN-PROGRESS design a FIR filter
...
** IN-PROGRESS [0/2] plot the data on the lcd
**** TODO [1/2] plot:
***** DONE voltage vs. time
***** TODO voltage vs. frequency
**** TODO plots modes switchable by interpreter commands            :eric:
