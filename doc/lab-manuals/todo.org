...
- [7/7] analysis and discussion :: 2 page maximum
  ...
  - [X] Without going back and actually measuring it, do you think the
     ...
     Explain.
#+todo: TODO(t) HB(b) ESC(e) | DONE(d)
** [2/7] Retry checkout
*** VERIFY adc sampling at 2 khz
follow the figure 2.4
*** DONE another thread for the serial
*** HB a thread to update the lcd with adc data
*** TODO jitter: defined as time past 2khz goal
*** DONE task: display threadcount to lcd, watch it increase with
button-created threads
*** TODO fft to smash the cpu and increase jitter
*** TODO task 4/5: from starter code. also to smash cpu for jitter
* [3/10] Lab 3
** [1/5] Preparation
