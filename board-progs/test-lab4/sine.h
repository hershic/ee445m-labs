...
/* Created by Hershal Bhave and Eric Crosson 2015-03-28 */
...
const uint32_t sine_length = 1024;
const uint16_t sine[] = {0x800,0x80d,0x819,0x826,0x832,0x83f,0x84b,0x858,
